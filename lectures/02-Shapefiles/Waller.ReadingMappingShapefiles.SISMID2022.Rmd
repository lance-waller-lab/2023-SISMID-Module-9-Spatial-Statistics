---
title: 'Waller SISMID 2022 Reading and Mapping Shapefiles:  Alcohol, Drugs, and Crime in Houston'
...
First, load the libraries and set my working directory (you'll need to change the working directory to your working directory).
...
Now to read in the shapefile.  You will need these files in your working directory:
...
We'll return to these data on Friday for our discussion of "Slippery Slopes".
